...
RSpec.describe AdministradorsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested administrador as @administrador" do
      administrador = Administrador.create! valid_attributes
      get :show, params: {id: administrador.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested administrador as @administrador" do
      administrador = Administrador.create! valid_attributes
      get :edit, params: {id: administrador.to_param}, session: valid_session
      expect(assigns(:administrador)).to eq(administrador)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Administrador" do
        expect {
          post :create, params: {administrador: valid_attributes}, session: valid_session
        }.to change(Administrador, :count).by(1)
      end

      it "assigns a newly created administrador as @administrador" do
        post :create, params: {administrador: valid_attributes}, session: valid_session
        expect(assigns(:administrador)).to be_a(Administrador)
        expect(assigns(:administrador)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved administrador as @administrador" do
        post :create, params: {administrador: invalid_attributes}, session: valid_session
        expect(assigns(:administrador)).to be_a_new(Administrador)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested administrador" do
        administrador = Administrador.create! valid_attributes
        put :update, params: {id: administrador.to_param, administrador: new_attributes}, session: valid_session
      ...
      it "assigns the requested administrador as @administrador" do
        administrador = Administrador.create! valid_attributes
        put :update, params: {id: administrador.to_param, administrador: valid_attributes}, session: valid_session
        expect(assigns(:administrador)).to eq(administrador)
      end
    ...
    context "with invalid params" do
      it "assigns the administrador as @administrador" do
        administrador = Administrador.create! valid_attributes
        put :update, params: {id: administrador.to_param, administrador: invalid_attributes}, session: valid_session
        expect(assigns(:administrador)).to eq(administrador)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested administrador" do
      administrador = Administrador.create! valid_attributes
      expect {
        delete :destroy, params: {id: administrador.to_param}, session: valid_session
      }.to change(Administrador, :count).by(-1)
    end
    ...
    it "redirects to the administradors list" do
      administrador = Administrador.create! valid_attributes
      delete :destroy, params: {id: administrador.to_param}, session: valid_session
      expect(response).to redirect_to(administradors_url)
    end
  end
